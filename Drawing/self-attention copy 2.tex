...
\tikzset{
  emb/.style = {draw, thick, color=white, rectangle, minimum width=3em, minimum height=1.3em, inner sep=0, outer sep=0},
  transformer/.style = {draw, thick, color=white, rectangle, minimum width=3em, minimum height=1.5em, text=white},
  ...
  posemb/.style = {draw, thick, color=white, rectangle, minimum width=3em, minimum height=1.3em, inner sep=0, outer sep=0},
  proj/.style = {draw, color=white, rectangle, minimum width=3em, minimum height=1.5em, inner sep=0, outer sep=0},
  FARROW/.style={arrows={-{Latex[length=1mm, width=0.8mm]}},color=white, thick}
}

\begin{figure*}
\centering
%\resizebox{\textwidth}{!}{
\begin{tikzpicture}[text=white, font=\bf]
...
\draw [decorate, decoration={brace,amplitude=5pt}, color=white, thick] ([xshift=-1mm] t1.south west) -- ([xshift=-1mm] tt1.north west) node[midway,xshift=-0.4cm, align=center] (w) {$L\times$};
...
\draw [decorate, decoration={brace,amplitude=5pt}, color=white, thick] ([xshift=-1mm] pe1.south west) -- ([xshift=-1mm] e1.north west) node[midway,xshift=-0.5cm, rotate=90, align=center, font=\scriptsize] (w) {Embedding\\ Layer};
